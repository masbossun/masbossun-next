---
title: Learn iOS Development 10/100 - About Swift Struct
date: "2022-12-26T14:57:44.919Z"
slug: learn-ios-development-10_100---about-swift-struct
author: Ryan Setiagi
git: https://github.com/masbossun/masbossun-next/blob/main/_posts/learn-ios-development-10_100---about-swift-struct.mdx
preview:
---
...
Unlike class that is a _Reference Type, struct is a _Value Type_ which has a technique called _copy on write_ means it only copies data whenever it changed. 
